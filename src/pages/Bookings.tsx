...
export default function Bookings() {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      // If you want to manually dismiss the toast, use toast.dismiss(toastId);
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 p-6 container mx-auto">
      ...
      {!isLoading && !isError && data!.length > 0 && tourData && (
        <>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  {tourData?.startDate instanceof Date
                    ? tourData.startDate.toLocaleDateString()
                    : tourData?.startDate}{" "}
                  to{" "}
                  {tourData?.endDate instanceof Date
                    ? tourData.endDate.toLocaleDateString()
                    : tourData?.endDate}
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      ...
                      disabled={guestCount >= Number(tourData!.maxGuest)}
                      className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center disabled:opacity-50"
                    >
                      +
                    </button>
